...
# https://raw.githubusercontent.com/ronghuaiyang/arcface-pytorch/master/models/metrics.py
...
class SphereProduct(nn.Module):
    ...
    def forward(self, input, label):
        ...
        one_hot = one_hot.cuda(label.device) if cos_theta.is_cuda else one_hot
